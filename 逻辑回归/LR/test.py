...
def LRTest():
    dataArr,labelArr = loadDataSet('/home/darou/文档/桌面/LALALA/逻辑回归/LR/horseColicTraining.txt')
    ...
    #TEST
    testArr,testlabelArr = loadDataSet('/home/darou/文档/桌面/LALALA/逻辑回归/LR/horseColicTest.txt')
